#!/bin/bash
#SBATCH --job-name=ml_2tasks_2nodes
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
srun --exclusive -N1 -n1 --cpus-per-task=112 python3 /home/bsc/bsc020513/analysis-grand-challenge/analyses/cms-open-data-ttbar/analysis.py --inference --output "output_1.root" > "output_1.log" 2> "error_1.log" 
